...
Реализовано по заданию `RELAYFORGE_TASK.md` (Go 1.26, Helm 4, Kubernetes ≥ 1.32).

## Быстрый старт

Предполагается: `docker`, `k3d`, `helm` (≥4.2), `go` (1.26) в окружении, рабочая директория — `relayforge/`.
